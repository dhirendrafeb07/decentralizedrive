    ...
    if (file) {
      try {
        ...
        const resFile = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `778e558a5666127115c3`,
            pinata_secret_api_key: `cc78022744a163b7e98d01f2d5b7e5a2ce744a65588cb7b4581f65e5e2f93c04`,
    ...
    <div className="top">
      <form className="form" onSubmit={handleSubmit}>
        <label htmlFor="file-upload" className="choose">
          Choose Image
          <i id="fa" class="fa-solid fa-image fa-xl mx-2"></i>
        </label>
        <input
          disabled={!account}
          type="file"
        ...
        <button type="submit" className="upload" disabled={!file}>
          Upload File
          <i id="fa" class="fa-solid fa-cloud-arrow-up fa-xl mx-2" ></i>
        </button>
      </form>
    </div>
  );
